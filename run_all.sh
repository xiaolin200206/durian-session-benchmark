...
CODE=$ROOT/github
SEEDS="${SEEDS:-42 1 2 3}"           # session-level; image-level control used 42 1 2
...
echo "=================================================================="
if [ -n "$DRY" ]; then
    echo "That was one seed at 2 epochs. The real run is 5 seeds x 2 regimes"
    echo "at 15+15 epochs, so scale accordingly before committing."
else
    echo "Now aggregate:"
